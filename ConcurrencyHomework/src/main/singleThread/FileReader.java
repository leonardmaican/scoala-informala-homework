...
/**
 * This is the standard, non-threaded implementation for the homework requirement
 */
...
public class FileReader {
    ...
    public FileReader(String inputPath, String outputPath) {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(String.valueOf(Paths.get(inputPath)))));
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (newPerson.getGender().equals(Gender.FEMALE)) {
                    if (newPerson.getDateOfBirth().getMonthValue() == LocalDate.now().getMonthValue() && newPerson.getDateOfBirth().getDayOfMonth() == LocalDate.now().getDayOfMonth()) {
                        try {
